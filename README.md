...
- Animation Creator tab for scene-side pose authoring, mouse joint posing, keyframe recording, loop playback, save/delete of custom animations, and optional mirroring/playback on a connected real robot
