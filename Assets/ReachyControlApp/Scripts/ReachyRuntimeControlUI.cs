    ...
    public class ReachyRuntimeControlUI : MonoBehaviour
    {
        ...
        private static LoopingAnimationDefinition[] BuildLoopingAnimationLibrary()
        {
            return new[]
            {
                ...
                new LoopingAnimationDefinition(
                    SpeechLoopingAnimationBName,
                    "More assertive speaking rhythm with right-hand emphasis, quick head checks, and brief reset beats.",
                    new LoopingAnimationKeyframe(
                        0.70f,
                        new LoopingAnimationJointGoal("neck_yaw", 4f),
                        new LoopingAnimationJointGoal("neck_pitch", 1f),
                        new LoopingAnimationJointGoal("neck_roll", 1f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -34f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -12f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -18f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -70f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -42f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 20f),
                        new LoopingAnimationJointGoal("r_wrist_roll", 12f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -14f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 10f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 8f),
                    ...
                    new LoopingAnimationKeyframe(
                        ...
                        new LoopingAnimationJointGoal("neck_pitch", -1f),
                        new LoopingAnimationJointGoal("neck_roll", -2f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -42f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -16f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -22f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -58f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -48f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 24f),
                        new LoopingAnimationJointGoal("r_wrist_roll", 16f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -18f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 13f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 10f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -96f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 20f),
                        new LoopingAnimationJointGoal("l_wrist_pitch", 12f),
                        new LoopingAnimationJointGoal("l_wrist_roll", -6f)),
                    new LoopingAnimationKeyframe(
                        0.55f,
                        new LoopingAnimationJointGoal("neck_yaw", 2f),
                        new LoopingAnimationJointGoal("neck_pitch", 3f),
                        new LoopingAnimationJointGoal("neck_roll", 0f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -22f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -10f),
                        ...
                        new LoopingAnimationJointGoal("l_arm_yaw", 12f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -84f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 28f),
                    ...
                    new LoopingAnimationKeyframe(
                        ...
                        new LoopingAnimationJointGoal("r_arm_yaw", -9f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -94f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -24f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 12f),
                        new LoopingAnimationJointGoal("r_wrist_roll", 4f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -33f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 18f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 18f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -72f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 42f),
                        new LoopingAnimationJointGoal("l_wrist_pitch", 20f),
                        new LoopingAnimationJointGoal("l_wrist_roll", -12f)),
                    new LoopingAnimationKeyframe(
                        0.72f,
                        new LoopingAnimationJointGoal("neck_yaw", 3f),
                        new LoopingAnimationJointGoal("neck_pitch", 1f),
                        new LoopingAnimationJointGoal("neck_roll", 1f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -32f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -12f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -16f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -72f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -40f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 18f),
                        new LoopingAnimationJointGoal("r_wrist_roll", 10f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -15f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 10f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 8f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -100f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 18f),
                        new LoopingAnimationJointGoal("l_wrist_pitch", 8f),
                        new LoopingAnimationJointGoal("l_wrist_roll", -3f))),
                new LoopingAnimationDefinition(
                    SpeechLoopingAnimationCName,
                    "Warmer conversational delivery with open-palmed framing, gentle nods, and a wider two-hand cadence.",
                    new LoopingAnimationKeyframe(
                        0.95f,
                        new LoopingAnimationJointGoal("neck_yaw", -3f),
                        new LoopingAnimationJointGoal("neck_pitch", 4f),
                        new LoopingAnimationJointGoal("neck_roll", -1f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -20f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -18f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -6f),
                        ...
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -20f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 18f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 6f),
                    ...
                    new LoopingAnimationKeyframe(
                        ...
                        new LoopingAnimationJointGoal("neck_pitch", 1f),
                        new LoopingAnimationJointGoal("neck_roll", 2f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -28f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -22f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -12f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -76f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -18f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 24f),
                        new LoopingAnimationJointGoal("r_wrist_roll", -14f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -28f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 22f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 12f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -76f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 18f),
                        new LoopingAnimationJointGoal("l_wrist_pitch", 24f),
                        new LoopingAnimationJointGoal("l_wrist_roll", 14f)),
                    new LoopingAnimationKeyframe(
                        0.72f,
                        new LoopingAnimationJointGoal("neck_yaw", 0f),
                        new LoopingAnimationJointGoal("neck_pitch", -1f),
                        ...
                        new LoopingAnimationJointGoal("r_shoulder_roll", -14f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -4f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -98f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -4f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 14f),
                        new LoopingAnimationJointGoal("r_wrist_roll", -4f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -14f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 14f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 4f),
                    ...
                    new LoopingAnimationKeyframe(
                        ...
                        new LoopingAnimationJointGoal("neck_roll", -2f),
                        new LoopingAnimationJointGoal("r_shoulder_pitch", -30f),
                        new LoopingAnimationJointGoal("r_shoulder_roll", -20f),
                        new LoopingAnimationJointGoal("r_arm_yaw", -10f),
                        new LoopingAnimationJointGoal("r_elbow_pitch", -74f),
                        new LoopingAnimationJointGoal("r_forearm_yaw", -20f),
                        new LoopingAnimationJointGoal("r_wrist_pitch", 22f),
                        new LoopingAnimationJointGoal("r_wrist_roll", -12f),
                        new LoopingAnimationJointGoal("l_shoulder_pitch", -18f),
                        new LoopingAnimationJointGoal("l_shoulder_roll", 15f),
                        new LoopingAnimationJointGoal("l_arm_yaw", 10f),
                        new LoopingAnimationJointGoal("l_elbow_pitch", -92f),
                        new LoopingAnimationJointGoal("l_forearm_yaw", 18f),
                        new LoopingAnimationJointGoal("l_wrist_pitch", 16f),
